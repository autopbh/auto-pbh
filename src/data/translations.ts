...
export const translations: TranslationsType = {
  ...
  pt: {
    ...
    "financing.customFinancing": "Financiamento Personalizado",
    ...
    "financing.ratesDescription": "Beneficie de taxas negociadas a partir de 2,9% com as nossas instituições bancárias parceiras.",
    "financing.instantSimulation": "Simulação Instantânea",
    "financing.simulationDescription": "Obtenha uma simulação personalizada online e receba um acordo de princípio em 2 horas.",
    "financing.flexibleOptions": "Opções Flexíveis",
    "financing.optionsDescription": "Escolha entre crédito clássico, leasing de longo prazo ou pagamento diferido de acordo com as suas preferências.",
    "financing.simulateFinancing": "Simule o seu financiamento",
    "financing.useCalculator": "Use a nossa calculadora para obter uma estimativa das suas mensalidades de acordo com o tipo de financiamento escolhido.",
    "financing.vehiclePrice": "Preço do veículo",
    "financing.initialContribution": "Contribuição inicial",
    ...
    "financing.calculateMonthlyPayment": "Calcular a minha mensalidade",
    "financing.estimatedMonthlyPayment": "Estimativa da sua mensalidade:",
    "financing.disclaimer": "* Esta estimativa é dada a título indicativo. A mensalidade final pode variar em função da aprovação do crédito e de outros fatores.",
    "financing.compareOptions": "Comparar opções de financiamento",
    "financing.contactAdvisor": "Contactar um conselheiro",
    "financing.error": "Erro de entrada",
    "financing.errorValues": "Por favor, verifique os valores inseridos.",
    "financing.errorContribution": "A contribuição inicial não pode ser superior ou igual ao preço do veículo.",
    "financing.calculationDone": "Cálculo efetuado",
    "financing.calculationSuccess": "A sua mensalidade foi calculada com sucesso.",
  },
  es: {
    // Navigation
    "nav.home": "Inicio",
