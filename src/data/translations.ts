...
export const translations: TranslationsType = {
  fr: {
    ...
    "cart.price": "Prix",
    "cart.emptyCart": "Votre panier est actuellement vide.",
    "cart.browseCatalog": "Parcourir notre catalogue",
    "cart.orderSummary": "Résumé de la commande",
    "cart.subtotal": "Sous-total",
    "cart.deposit": "Acompte à verser",
    "cart.totalPrice": "Prix total",
    "cart.remove": "Supprimer",
    "cart.requestPaymentInfo": "Demander les informations de virement",
    "cart.paymentInstructionsTitle": "Instructions de paiement",
    "cart.wireTransferInstructions": "Veuillez effectuer un virement bancaire avec les informations suivantes :",
    "cart.amount": "Montant",
    "cart.recipient": "Bénéficiaire",
    "cart.bank": "Banque",
    "cart.reference": "Référence",
    "cart.important": "Important",
    "cart.depositRequired": "L'acompte est requis pour réserver votre véhicule. Le solde sera à régler avant la livraison.",
    "cart.referenceNote": "Veuillez indiquer la référence exacte dans votre virement pour faciliter le traitement.",
    "cart.termsAgreement": "En continuant, vous acceptez nos",
    "cart.termsLink": "conditions générales",
    "cart.and": "et",
    ...
    "cart.paymentRequestSent": "Demande d'acompte envoyée",
    "cart.paymentInstructions": "Veuillez effectuer le virement dans les 3 jours pour confirmer votre réservation.",
  ...
  en: {
    ...
    "cart.price": "Price",
    "cart.emptyCart": "Your cart is currently empty.",
    "cart.browseCatalog": "Browse our catalog",
    "cart.orderSummary": "Order Summary",
    "cart.subtotal": "Subtotal",
    "cart.deposit": "Deposit required",
    "cart.totalPrice": "Total price",
    "cart.remove": "Remove",
    "cart.requestPaymentInfo": "Request payment information",
    "cart.paymentInstructionsTitle": "Payment instructions",
    "cart.wireTransferInstructions": "Please make a bank transfer with the following information:",
    "cart.amount": "Amount",
    "cart.recipient": "Recipient",
    "cart.bank": "Bank",
    "cart.reference": "Reference",
    "cart.important": "Important",
    "cart.depositRequired": "The deposit is required to reserve your vehicle. The balance will be due before delivery.",
    "cart.referenceNote": "Please indicate the exact reference in your transfer to facilitate processing.",
    "cart.termsAgreement": "By continuing, you agree to our",
    "cart.termsLink": "terms of service",
    "cart.and": "and",
    ...
    "cart.paymentRequestSent": "Deposit request sent",
    "cart.paymentInstructions": "Please make the transfer within 3 days to confirm your reservation.",
  ...
  pt: {
    ...
    "cart.price": "Preço",
    "cart.emptyCart": "O seu carrinho está atualmente vazio.",
    "cart.browseCatalog": "Navegar pelo nosso catálogo",
    "cart.orderSummary": "Resumo do pedido",
    "cart.subtotal": "Subtotal",
    "cart.deposit": "Depósito necessário",
    "cart.totalPrice": "Preço total",
    "cart.remove": "Remover",
    "cart.requestPaymentInfo": "Solicitar informações de pagamento",
    "cart.paymentInstructionsTitle": "Instruções de pagamento",
    "cart.wireTransferInstructions": "Por favor, faça uma transferência bancária com as seguintes informações:",
    "cart.amount": "Montante",
    "cart.recipient": "Beneficiário",
    "cart.bank": "Banco",
    "cart.reference": "Referência",
    "cart.important": "Importante",
    "cart.depositRequired": "O depósito é necessário para reservar o seu veículo. O saldo será devido antes da entrega.",
    "cart.referenceNote": "Por favor, indique a referência exata na sua transferência para facilitar o processamento.",
    "cart.termsAgreement": "Ao continuar, você concorda com os nossos",
    "cart.termsLink": "termos de serviço",
    "cart.and": "e",
    ...
    "cart.paymentRequestSent": "Solicitação de depósito enviada",
    "cart.paymentInstructions": "Por favor, faça a transferência dentro de 3 dias para confirmar a sua reserva.",
    "cart.yourCart": "Seu Carrinho",
    "cart.itemSingular": "item",
    "cart.itemsPlural": "itens",
  ...
  es: {
    ...
    "shop.reserved": "Reservado",
    "shop.sold": "Vendido",
    "shop.alreadyInCart": "Vehículo ya en carrito",
    ...
    "vehicle.tradeIn": "Retoma de su vehículo antiguo",
    ...
    "catalog.advancedSearchDesc": "Utilice nuestros filtros detallados para encontrar exactamente el vehículo que le conviene.",
    "catalog.customFilters": "Filtros Personalizados",
    ...
    "search.description": "Utilice nuestro motor de búsqueda inteligente para encontrar el vehículo que se adapte perfectamente a sus criterios de nuestra selección exclusiva.",
    "search.placeholder": 'Escriba "Mercedes Clase S 2023" o explore sus criterios...',
    ...
    "footer.newsletter": "Suscríbase a nuestro newsletter exclusivo para recibir avances de nuestras últimas adquisiciones y ofertas privilegiadas.",
    ...
    "cart.price": "Precio",
    "cart.emptyCart": "Su carrito está actualmente vacío.",
    "cart.browseCatalog": "Explorar nuestro catálogo",
    "cart.orderSummary": "Resumen del pedido",
    "cart.subtotal": "Subtotal",
    "cart.deposit": "Depósito necesario",
    "cart.totalPrice": "Precio total",
    "cart.remove": "Eliminar",
    "cart.requestPaymentInfo": "Solicitar información de pago",
    "cart.paymentInstructionsTitle": "Instrucciones de pago",
    "cart.wireTransferInstructions": "Por favor, realice una transferencia bancaria con la siguiente información:",
    "cart.amount": "Importe",
    "cart.recipient": "Beneficiario",
    "cart.bank": "Banco",
    "cart.reference": "Referencia",
    "cart.important": "Importante",
    "cart.depositRequired": "El depósito es necesario para reservar su vehículo. El saldo se deberá pagar antes de la entrega.",
    "cart.referenceNote": "Por favor, indique la referencia exacta en su transferencia para facilitar el procesamiento.",
    "cart.termsAgreement": "Al continuar, acepta nuestros",
    "cart.termsLink": "términos de servicio",
    "cart.and": "y",
    "cart.privacyLink": "política de privacidad",
    "cart.itemRemoved": "Artículo eliminado",
    "cart.itemRemovedDesc": "El artículo ha sido eliminado de su carrito.",
    "cart.paymentRequestSent": "Solicitud de depósito enviada",
    "cart.paymentInstructions": "Por favor, realice la transferencia en 3 días para confirmar su reserva.",
    "cart.yourCart": "Su Carrito",
    "cart.itemSingular": "artículo",
    "cart.itemsPlural": "artículos",
