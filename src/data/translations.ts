...
export const translations: TranslationsType = {
  ...
  nl: {
    ...
    "home.advantages.warranty.title": "Verlengde garantie",
    "home.advantages.warranty.text": "We bieden verlengde garanties op al onze voertuigen om volledige gemoedsrust na uw aankoop te verzekeren.",
    "home.advantages.delivery.title": "Europese levering",
    "home.advantages.delivery.text": "We leveren uw voertuig overal in Europa met realtime tracking en een professionele, veilige transportservice.",
    "home.testimonials.title": "Wat onze klanten zeggen",
    "home.cta.title": "Ontdek Automotive Excellentie",
    "home.cta.subtitle": "Ons team van experts staat tot uw beschikking om u te helpen bij het selecteren van het voertuig dat perfect zal aansluiten bij uw eisen.",
    ...
    "search.description": "Gebruik onze intelligente zoekmachine om het voertuig te vinden dat perfect aansluit bij uw criteria uit onze exclusieve selectie.",
    "search.placeholder": 'Type "Mercedes S-Klasse 2023" of scan uw criteria...',
    ...
    // Footer
    "footer.description": "AUTO PBH - Automotive excellence tot uw dienst. Ontdek onze exclusieve selectie van premium voertuigen en geniet van een gepersonaliseerde aankoopervaring.",
    "footer.address": "Autolettestraat 10,",
    "footer.city": "3063 NP Rotterdam,",
    ...
    "footer.financing": "Aangepaste Financieringsoplossingen",
    ...
    "footer.stayInformed": "Blijf op de Hoogte",
    ...
    "footer.copyright": "© {year} AUTO PBH. Automotive Excellentie.",
